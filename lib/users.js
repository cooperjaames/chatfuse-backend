...
const upsertConnection = db.prepare(`
  INSERT INTO connections (user_id, platform, access_token, refresh_token, platform_user_id, platform_login, updated_at)
  VALUES (?, ?, ?, ?, ?, ?, unixepoch())
...
export function linkPlatformConnection(userId, platform, { accessToken, refreshToken, platformUserId, platformLogin }) {
  upsertConnection.run(userId, platform, accessToken, refreshToken || null, platformUserId || null, platformLogin || null);
}
